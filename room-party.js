...
export class RoomParty {
 ...
 finish(){if(this.engine?.winner||this.engine?.metadata?.ended){this.remainingMs=this.remaining();this.phase=this.engine.winner?'solved':'ended';this.runningSince=null;this.reason=this.engine.winner?'gameWon':'gameLost';this.engine.release();}}
 tick(){
